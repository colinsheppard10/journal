...
exports.Journal = (() => {
    ...
    var Journal = _classThis = class extends typeorm_1.BaseEntity {
        constructor() {
            super(...arguments);
    ...
    __setFunctionName(_classThis, "Journal");
    (() => {
        ...
        Journal = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Journal = _classThis;
})();
