...
router.post("/api/user/signin", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/api/user/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/api/user/verify", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { uuid } = req.body;
...
router.post("/api/user/forgot", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        const { email } = req.body;
...
router.post("/api/user/reset", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
