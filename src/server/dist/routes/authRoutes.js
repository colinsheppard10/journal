...
router.post("/user/get", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { user } = req;
        res.json({ user });
    }
...
router.post("/journal/create", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { user } = req;
...
router.post("/journal/get", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { user } = req;
...
router.post("/summary/create", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let { user } = req;
